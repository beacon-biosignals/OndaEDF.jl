...
const STANDARD_LABELS = Dict(# This EEG channel name list is a combined 10/20 and 10/10
                             ...
                             ["eeg"] => ["pg1", "nz", "pg2",
                                         ...
                                         "fc4", "fc6", "ft8", "ft10",
                                         "a1", "m1", "t9", "t7", "t3", "c5", "c3", "c1",
                                         "cz", "c2", "c4", "c6", "t4", "t8", "t10", "a2",
                                         "m2",
                                         "tp9", "tp7", "cp5", "cp3", "cp1", "cpz", "cp2",
                                         "cp4", "cp6", "tp8", "tp10",
                                         "t5", "p9", "p7", "p5", "p3", "p1", "pz", "p2",
                                         "p4", "p6", "p8", "p10", "t6",
                                         "po7", "po3", "poz", "po4", "po8",
                                         "o1" => ["01"], "oz", "o2" => ["02"],
                                         "iz"],
                             ...
                             ["eog", "eeg"] => ["left" => ["eogl", "loc", "lefteye", "leye",
                                                           "e1", "eog1", "l", "left eye",
                                                           "leog", "log", "li", "lue"],
                                                "right" => ["eogr", "roc", "righteye",
                                                            "reye", "e2", "eog2", "r",
                                                            "right eye", "reog", "rog",
                                                            "re", "rae"]],
                             ["emg"] => ["chin1" => ["chn", "chin_1", "chn1", "kinn",
                                                     "menton", "submental", "submentalis",
                                                     "submental1", "subm1", "chin",
                                                     "mentalis", "chinl", "chinli",
                                                     "chinleft", "subm_1", "subment"],
                                         "chin2" => ["chn2", "chin_2", "submental2",
                                                     "subm2", "chinr", "chinre",
                                                     "chinright", "subm_2"],
                                         "chin3" => ["chn3", "submental3", "subm3",
                                                     "chincenter"],
                                         "intercostal" => ["ic"],
                                         "left_anterior_tibialis" => ["lat", "lat1", "l",
                                                                      "left", "leftlimb",
                                                                      "tibl", "tibli",
                                                                      "plml", "leg1",
                                                                      "lleg", "lleg1",
                                                                      "legl", "jambe_l",
                                                                      "leftleg"],
                                         "right_anterior_tibialis" => ["rat", "rat1", "r",
                                                                       "right", "rightlimb",
                                                                       "tibr", "tibre",
                                                                       "plmr", "leg2",
                                                                       "leg3", "rleg",
                             ...
                             ["emg_ambiguous", "emg"] => ["1" => ["aux1", "l"],
                                                          "2" => ["aux2", "r"],
                                                          "3" => ["aux3"]],
                             ["heart_rate"] => ["heart_rate" => ["hr", "pulse", "pulso",
                                                                 "pr", "pulserate"]],
                             ["snore"] => ["snore" => ["ronquido", "ronquido derivad",
                                                       "schnarchen", "ronfl",
                                                       "schnarchmikro"]],
                             ["positive_airway_pressure", "pap"] => ["ipap", "epap", "cpap"],
                             ["pap_device_cflow"] => ["pap_device_cflow" => ["cflow",
                                                                             "airflow",
                                                                             "flow"]],
                             ["pap_device_cpres"] => ["pap_device_cpres" => ["cpres"]],
                             ["pap_device_leak"] => ["pap_device_leak" => ["leak",
                                                                           "airleak"]],
                             ["ptaf"] => ["ptaf"],
                             ["respiratory_effort"] => ["chest" => ["thorax", "torax",
                                                                    "brust", "thor"],
                                                        "abdomen" => ["abd", "abdo",
                                                                      "bauch"]],
