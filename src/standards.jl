...
const STANDARD_LABELS = Dict(# This EEG channel name list is a combined 10/20 and 10/10
                             ...
                             ["emg"] => ["chin1" => ["chn", "chin1", "chn1", "submental", "submentalis", "submental1", "chin", "mentalis", "chinl", "chinleft"],
                                         "chin2" => ["chin2", "chn2", "submental2", "subm2", "chinr", "chinright"],
                                         "chin3" => ["chin3", "chn3", "submental3", "chincenter"],
                                         "intercostal"=> ["ic"],
                                         "left_anterior_tibialis"=> ["lat", "l", "left"],
                                         "right_anterior_tibialis"=> ["rat", "r", "right"]],
                             ...
                             ["ptaf"] => ["ptaf"],
                             ["respiratory_effort"] => ["chest" => ["thorax", "torax", "brust"], "abdomen"=> ["abd", "bauch"]],
