...
const STANDARD_LABELS = Dict(# This EEG channel name list is a combined 10/20 and 10/10
                             ...
                             ["ecg", "ekg"] => ["i", "ii", "iii",
                                                ...
                                                "x", "y", "z"],
                             ["eog"] => ["left"=> ["eogl", "loc", "lefteye", "leye", "e1", "l", "left eye"],
                                         "right"=> ["eogr", "roc", "righteye", "reye", "e2", "r", "right eye"]],
                             ["emg"] => ["chin1" => ["chin 1", "chn1"], "chin2" => ["chin 2", "chn2"], "chin3" => ["chin 3", "chn3"],
                                         "intercostal"=> ["ic"],
                             ...
                             ["ptaf"] => ["ptaf"],
                             ["respiratory_effort"] => ["chest" => ["thorax", "torax"], "abdomen"=> ["abd"]],
