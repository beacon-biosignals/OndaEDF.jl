...
const STANDARD_LABELS = Dict(# This EEG channel name list is a combined 10/20 and 10/10
                             ...
                             ["emg"] => ["chin1" => ["chn", "chin1", "chn1", "kinn", "menton", "submental", "submentalis", "submental1", "subm1", "chin", "mentalis", "chinl", "chinleft", "subm_1"],
                                         "chin2" => ["chin2", "chn2", "submental2", "subm2", "chinr", "chinright", "subm_2"],
                                         "chin3" => ["chin3", "chn3", "submental3", "subm3", "chincenter"],
                                         "fp1", "fp2",
                                         "intercostal"=> ["ic"],
